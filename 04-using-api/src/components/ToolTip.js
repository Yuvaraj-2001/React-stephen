...
//       setToolbarPosition({
//         top: rect.top + window.scrollY - 40, // Adjust to position toolbar above the selection
//         left: rect.left + rect.width / 2, // Center the toolbar horizontally
//       });
//       setShowToolbar(true);
//     } else {
//       setShowToolbar(false); // Hide the toolbar if no text is selected
//     }
//   };

//   const applyFormatting = (format) => {
//     document.execCommand(format, false, null);
//     setShowToolbar(false); // Hide the toolbar after applying formatting
//   };
...
//         }}
//       >
//         Select some text to see the toolbar and apply formatting like Medium.
//       </div>
